...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F0EA] font-sans text-gray-800 selection:bg-[#7A1B1B] selection:text-white relative">
      ...
      <a href="https://wa.me/51967211722" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1DA851] text-white p-4 rounded-full shadow-[0_8px_30px_rgb(37,211,102,0.4)] hover:scale-110 transition-all duration-300 animate-[pulse_2s_infinite] group hover:animate-none">
